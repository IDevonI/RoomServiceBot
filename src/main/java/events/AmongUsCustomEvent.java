...
public class AmongUsCustomEvent extends ListenerAdapter {
    ...
    public void onGuildVoiceJoin(@NotNull GuildVoiceJoinEvent event)
    {
        new Thread(() -> {
            ...
            if (event.getChannelJoined().getId().equals("798388491826102302")) {
                ...
                int i;
                for (i = 1; found; i++) {
                    found = ChannelNames.amongUsCustom.contains(i);
                }
                ChannelNames.amongUsCustom.add(i - 1);
                name = "「\uD83D\uDD08」 #" + (i - 1) + " AU Custom";
    ...
    public void onGuildVoiceMove(@NotNull GuildVoiceMoveEvent event) {
        new Thread(() -> {
            ...
            } else if (Objects.requireNonNull(event.getChannelLeft().getParent()).getId().equals("797310513779703859") && !event.getChannelLeft().getId().equals("798388491826102302")) {
